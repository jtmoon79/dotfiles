...
function bash_print_OS () {
    ...
    local uname_=
    uname_=$(uname -s) 2>/dev/null || true
...
function bash_prompt_table_variable_add_net_IPv4 () {
    ...
    devname_varname=${devname_varname//']'/_}
    devname_varname=${devname_varname//'.'/_}
    # BUG: Bash <4 will emit an error due to -g
    declare -g IPv4_${devname_varname}=${ipv4}  # global
...
function __bash_update_dotbashrc_builtins () {
    ...
    chmod ugo-w './.bashrc.builtins.post'
}
